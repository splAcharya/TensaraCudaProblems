...
- `tensara_2`: `6144 x 4096`
  ...
  - scale best: `float4 = 1.123 ms` at `(512, 16)`
- `tensara_3`: `4096 x 7168`
  - default best: `float4 = 1.321 ms`
  - scale best: `float4 = 1.308 ms` at `(512, 16)`
- `tensara_4`: `4096 x 8192`
  - default best: `float4 = 1.509 ms`
  - scale best: `float4 = 1.496 ms` at `(64, 128)`
- `tensara_5`: `8192 x 8192`
  - default best: `float4 = 3.015 ms`
  - scale best: `float4 = 2.976 ms` at `(512, 16)`

Default-launch `kernel_ms` by variant:

- `tensara_1`: `basic 0.817`, `float4 0.756`
- `tensara_2`: `basic 1.224`, `float4 1.137`
- `tensara_3`: `basic 1.422`, `float4 1.321`
- `tensara_4`: `basic 1.619`, `float4 1.509`
- `tensara_5`: `basic 3.276`, `float4 3.015`

Best launch-sweep `kernel_ms` by variant:

- `scale_tensara_1`: `basic 0.796` at `(256, 64)`,
  `float4 0.752` at `(64, 128)`
- `scale_tensara_2`: `basic 1.192` at `(128, 128)`,
  `float4 1.123` at `(512, 16)`
- `scale_tensara_3`: `basic 1.388` at `(128, 128)`,
  `float4 1.308` at `(512, 16)`
- `scale_tensara_4`: `basic 1.582` at `(128, 128)`,
  `float4 1.496` at `(64, 128)`
- `scale_tensara_5`: `basic 3.192` at `(256, 64)`,
  `float4 2.976` at `(512, 16)`
